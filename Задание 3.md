...
```bash
{
  ...
  students: [
    { age: 19, group: "ИКБО-4-20", name: "Годов И.П." },
    { age: 18, group: "ИКБО-5-20", name: "Ларин П.Е." },
    { age: 18, group: "ИКБО-5-20", name: "Сидоров М.С." },
    { age: 20, group: "ИКБО-6-20", name: "Козубов О.Е." } // новый студент
  ],
