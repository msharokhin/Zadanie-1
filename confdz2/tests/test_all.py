...
from confdz2.src.main import read_config, get_commit_hash_by_tag, build_dependency_graph
...
@patch("confdz2.src.main.os.path.exists", return_value=True)
...
@patch("confdz2.src.main.read_git_object", return_value="commit_content")
@patch("confdz2.src.main.parse_commit", return_value=(["parent_hash"], "commit_message"))
